...
.. config:section:: couchdb :: Base CouchDB Options
    ...
    .. config:option:: fsync_options :: Fsync options
        ...
        the contents of any file system buffers kept by the operating system
        are flushed to disk. There is generally no need to modify this
        parameter.
    ...
    .. config:option:: os_process_timeout :: External processes time limit
        ...
        expedient errors, but you may want to tweak it for your specific needs.
